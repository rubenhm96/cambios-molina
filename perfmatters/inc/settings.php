...
function perfmatters_settings() {
    ...
    //fonts options section
    add_settings_section('perfmatters_fonts', __('Fonts', 'perfmatters') . '<span class="perfmatters-beta">BETA</span>', 'perfmatters_fonts_callback', 'perfmatters_options');
    ...
    add_settings_field(
        ...
        array(
            'section' => 'fonts',
            'id' => 'display_swap',
            'class' => 'disable_google_fonts' . (!empty($perfmatters_options['disable_google_fonts']) ? ' hidden' : ''),
...
function perfmatters_fonts_callback() {
...
function perfmatters_print_input($args) {
    ...
    if(!empty($args['input']) && ($args['input'] == 'text' || $args['input'] == 'color')) {
        echo "<input type='text' id='" . $selection_id . "' name='" . $option . "[" . $args['id'] . "]' value='" . (!empty($options[$args['id']]) ? $options[$args['id']] : '') . "' placeholder='" . (!empty($args['placeholder']) ? $args['placeholder'] : '') . "' />";
    }
