...
class tiempo_widget extends WP_Widget
{
    ...
    {
        $widget_options = array('classname' => 'tiempo_widget', 'description' => 'Spanish weather forecast widget. All locations around the world');
