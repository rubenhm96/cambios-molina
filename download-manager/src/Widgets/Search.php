...
class Search extends \WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if(wpdm_valueof($instance, 'rpage') > 0) {
            ...
            Messages::warning(__( "Search result page was configured properly. Please create a page with shortcode [wpdm_search_result] and select thee page from widget settings", "download-manager" ), 0);
        }
    }
