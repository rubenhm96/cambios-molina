...
?>
<select multiple="multiple" name="<?php echo esc_attr( isset( $field['name'] ) ? $field['name'] : $key ); ?>[]" id="<?php echo esc_attr( $key ); ?>" class="restaurant-listings-multiselect" <?php if ( ! empty( $field['required'] ) ) echo 'required'; ?> data-no_results_text="<?php _e( 'No se encontraron resultados', 'wp-restaurant-listings' ); ?>" data-multiple_text="<?php _e( 'Seleccione alguna opción', 'wp-restaurant-listings' ); ?>">
