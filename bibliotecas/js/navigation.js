...
( function() {
	...
	//Icono de Inicio
	document.getElementById("menu-item-29").firstChild.textContent="";
	document.getElementById("menu-item-29").firstChild.innerHTML="<i class='bi-house-door-fill' style='font-size:1rem'></i>";
	//Buscador Navegador
	...
	const parentrrss = document.getElementsByClassName("menu-menu-biblioteca-container");
