	...
	<div class="wppsac-post-content-position">
		...
		<?php if( $showDate || $showAuthor ) { ?>
			<div class="wppsac-post-date">
				<?php if( $showAuthor ) { ?>
					<span><?php  esc_html_e( 'Por', 'wp-responsive-recent-post-slider' ); ?> <?php the_author(); ?></span>
				<?php }
		...
		<?php if( $showContent ) {  ?>
			<div class="wppsac-post-content">
				...
				<?php } ?>
				<?php if( $showreadmore ) { ?>
					<a class="wppsac-readmorebtn" href="<?php the_permalink(); ?>"><?php _e('Leer Más', 'wp-responsive-recent-post-slider'); ?></a>
				<?php } ?>
			</div>
		<?php } ?>
	</div>
