	...
	public function register_post_types() {
			...
			register_taxonomy( "restaurant_listings_category",
				...
				apply_filters( 'register_taxonomy_restaurant_listings_category_args', array(
					...
					'labels' => array(
						...
						'search_items'      => sprintf( __( 'Buscar %s', 'wp-restaurant-listings' ), $plural ),
						'all_items'         => sprintf( __( 'Todo %s', 'wp-restaurant-listings' ), $plural ),
						'parent_item'       => sprintf( __( 'Padre %s', 'wp-restaurant-listings' ), $singular ),
						'parent_item_colon' => sprintf( __( 'Padre %s:', 'wp-restaurant-listings' ), $singular ),
						'edit_item'         => sprintf( __( 'Editar %s', 'wp-restaurant-listings' ), $singular ),
						'update_item'       => sprintf( __( 'Actualizar %s', 'wp-restaurant-listings' ), $singular ),
						'add_new_item'      => sprintf( __( 'Añadir Nuevo %s', 'wp-restaurant-listings' ), $singular ),
						'new_item_name'     => sprintf( __( 'Nuevo %s Nombre', 'wp-restaurant-listings' ),  $singular )
					),
					'show_ui' 				=> true,
					'show_tagcloud'			=> false,
					'public' 	     		=> $public,
	    ...
	    register_post_type( "restaurant_listings",
			apply_filters( "register_post_type_restaurant_listings", array(
				...
				'description' => sprintf( __( 'Aquí es donde puede crear y administrar %s.', 'wp-restaurant-listings' ), $plural ),
				'public' 				=> true,
				'show_ui' 				=> true,
