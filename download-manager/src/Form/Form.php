...
class Form
{
    ...
    function render()
    {
        ...
        $before_form_fields = "";
        $form_html .= apply_filters("wppmsg_form_{$this->id}_before_fields", $before_form_fields, $this);
        ...
        $after_form_fields = "";
        $form_html .= apply_filters("wppmsg_form_{$this->id}_before_fields", $after_form_fields, $this);
