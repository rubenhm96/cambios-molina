        ...
        $(".<?php echo $form_id; ?>").submit(function(){
            ...
            $(this).ajaxSubmit({
                ...
                success:function(res){
                    ...
                    if( res.downloadurl ) {
                        jQuery('#wpdm-lock-options').html("<div class='card'><div class='card-body text-center'>"+res.msg+"</div><div class='card-footer'><a target=_blank style=\'margin-top:5px;color:#fff !important\' class=\'btn btn-success btn-lg btn-block\' href=\'"+res.downloadurl+"\'><?php echo $button_label; ?></a></div></div>");
                    } else {
