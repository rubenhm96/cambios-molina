		...
		<div class="div-contacta-parent">
			<div class="row">
				...
				<div class="div-contacta">
					<a href="" class="col-lg-3 col-md-4 col-sm-6 col-12 btn-contacta"><i class="bi bi-telephone-fill btn-4"></i><span class="btn-3">TELÉFONO</span></a>
					<a href="" class="col-lg-3 col-md-4 col-sm-6 col-12 btn-contacta"><i class="bi bi-person-fill btn-4"></i><span class="btn-3">PRESENCIAL</span></a>
					<a href="" class="col-lg-3 col-md-4 col-sm-6 col-12 btn-contacta"><i class="bi bi-display btn-4"></i><span class="btn-3">INTERNET</span></a>
				</div>
			</div>
		</div>
	</main><!-- #main -->
