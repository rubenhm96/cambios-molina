...
?>
	...
	<footer id="colophon" class="site-footer text-center text-lg-start bg-light text-muted">
			...
			<div class="container text-center text-md-start mt-5">
				...
				<div class="row mt-3">
					...
					<div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
						...
						<p>
							<a href="http://pruebasacceso.molinadesegura.es/transparencia" class="text-reset">Transparencia</a>
						</p>
					</div>
					<!-- Grid column -->
					...
					<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
						...
						<p>
							<a href="http://pruebasacceso.molinadesegura.es/juventud/mapaweb/" class="text-reset">Mapa Web</a>
						</p>
						<p>
					...
					<div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
						...
						<p class="row">
							<span class="col-5">
							<img src="http://pruebasacceso.molinadesegura.es/juventud/wp-content/uploads/sites/11/2021/05/logos-molina-footer-blanco-2.png" alt="">
							</span>
							<span class="col-7">
							<img src="http://pruebasacceso.molinadesegura.es/juventud/wp-content/uploads/sites/11/2021/05/logo-dereca.png" alt="">
							</span>
						</p>
		...
		<div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
			© 2021 Copyright
			<a class="text-reset fw-bold" href="http://pruebasacceso.molinadesegura.es/juventud">Juventud</a>
		</div>
		<!-- Copyright -->
	</footer><!-- #colophon -->
</div><!-- #page -->
