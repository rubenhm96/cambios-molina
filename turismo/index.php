		...
		<!--Plugin El tiempo-->
			<a href="http://www.aemet.es/es/eltiempo/prediccion/municipios/molina-de-segura-id30027" class="div-weather">
				...
				<section id="tiempo_widget-2" class="widget tiempo_widget">
					<div id="tiempo-widget-enlace" class="tiempo-widget weather_widget_wrap tight" data-background="#005fba" data-text-color="#fff"  data-width="tight" data-days="0" data-sunrise="false" data-wind="false" data-current="on" data-language="spanish" data-city="Murcia" data-country="Spain"></div>
				</section>
			</a>
		</div>
