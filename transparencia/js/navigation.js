...
function startJS(){
	...
	buscador.innerHTML+="<li class='mega-menu-item mega-menu-item-type-post_type mega-menu-item-object-page mega-align-bottom-left mega-menu-flyout mega-menu-item-12'><form role='search' method='get' class='search-form' action='http://172.28.0.120/transparencia/'>"+
