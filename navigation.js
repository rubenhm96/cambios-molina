...
( function() {
	...
	buscador.innerHTML+="<form role='search' method='get' class='search-form' action='http://172.28.0.120/wordpress/'>"+
	...
	for(let i=0; i<menubutton.length; i++){
		menubutton[i].innerHTML="<i class='bi-list' style='font-size: 2rem'></i>"
	}
