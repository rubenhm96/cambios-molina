		...
		?>
			<div class="qc-review-notice">
				...
				<div class="qc-review-text">
					...
					<h3><?php _e( 'Leave A Review for Simple Business Directory?', 'qc-sld' ) ?></h3>
					
					<p><?php _e( 'We hope you\'ve enjoyed using <b>Simple Business Directory</b>! Would you consider leaving us a review on WordPress.org?', 'qc-opd' ) ?></p>
