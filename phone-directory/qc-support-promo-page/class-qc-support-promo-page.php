...
if( !class_exists('QcPDSupportAndPromoPage') ){


	class QcPDSupportAndPromoPage{
                        ...
                        <div class="support-btn-main clearfix-div">
                            ...
                            <div class="qc-column-12">
                                ...
                                <div class="support-btn">
                                    ...
                                    <a class="premium-support premium-support-width" href="https://www.quantumcloud.com/resources/kb-sections/simple-business-directory/" target="_blank">Online KnowledgeBase</a>
                                </div>
	...
	} //End of the class QcPDSupportAndPromoPage
...
//Supply Unique Promo Page Slug as the constructor parameter of the class QcPDSupportAndPromoPage. ex: sld-page-2124a to the constructor

//Please create an unique instance for your use, example: $instance_sldf2

$instance_pdf_suport = new QcPDSupportAndPromoPage('pd-free-page-143pd');

if( is_admin() )
{
	$instance_pdf_suport->plugin_menu_slug = "edit.php?post_type=pnd";
	$instance_pdf_suport->plugin_name = "Phone Directory";
	$instance_pdf_suport->show_promo_page();
}
