            ...
            <table cellspacing=0 cellpadding=0 border=0 class="clear" id="campaign_fields">
				...
				<?php if ( isset( $fields_data[ 'campaign_id' ] ) ) { ?>
					<tr>
						<td colspan="2">
							<div class="clear"></div>
							<div class="inlineMessageInfo"><strong>To show this campaign please put the following shortcode [cm_ad_changer campaign_id="<?php echo $fields_data[ 'campaign_id' ]; ?>"] on any page or post or use the Ad Changer sidebar widget found the in your WordPress widgets area with the campaign number "<?php echo $fields_data[ 'campaign_id' ]; ?>".</strong></div>
							<div class="clear"></div>
						</td>
					</tr>
				<?php } ?>
