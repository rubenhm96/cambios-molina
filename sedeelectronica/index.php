...
?>
	...
	<main id="primary" class="site-main max-width">
		<div class="row div-parent-click max-width-content">
			...
			<a href="/sedeelectronica/tramites-destacados/" class=" col-lg-3 col-md-4 col-sm-6 col-6 btn-a-un-click"><i class="bi bi-paperclip btn-2"></i><span class="btn-1 from-right">Trámites Destacados</span></a>
			...
			<a href="/sedeelectronica/registro-electronico/" class=" col-lg-3 col-md-4 col-sm-6 col-6 btn-a-un-click"><i class="bi bi-at btn-2"></i><span class="btn-1 from-right">Registro Electrónico</span></a>
			<a href="/sedeelectronica/validacion-de-documentos/" class=" col-lg-3 col-md-4 col-sm-6 col-6 btn-a-un-click"><i class="bi bi-file-earmark-arrow-up-fill btn-2"></i><span class="btn-1 from-right">Validación de Documentos</span></a>
			...
			<a href="/sedeelectronica/normativa-municipal/" class=" col-lg-3 col-md-4 col-sm-6 col-6 btn-a-un-click"><i class="bi bi-file-text-fill btn-2"></i><span class="btn-1 from-right">Normativa Municipal</span></a>
			<a href="/sedeelectronica/sugerencias-y-quejas/" class=" col-lg-3 col-md-4 col-sm-6 col-6 btn-a-un-click"><i class="bi bi-envelope-open-fill btn-2"></i><span class="btn-1 from-right">Sugerencias y Quejas</span></a>
