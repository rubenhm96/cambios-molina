...
<form method="post" id="restaurant_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
	<div class="restaurant_listings_preview_title">
		...
		<input type="submit" name="edit_restaurant" class="button restaurant-listings-button-edit-listings" value="<?php _e( 'Editar listas', 'wp-restaurant-listings' ); ?>" />
		<h2><?php _e( 'Vista Previa', 'wp-restaurant-listings' ); ?></h2>
	</div>
