	...
	<main id="primary" class="site-main max-width">
		...
		<div class="row div-eventos max-width-content">
			...
			<div class="div-prox-eventos col-lg-8 col-md-8 col-sm-12 col-12">
				...
				<a class="btn btn-secundary" href="http://pruebasacceso.molinadesegura.es/">Ver Más Eventos</a>
			</div>
		</div>
		<div class="row div-noticias max-width-content">
			...
			<div class="col-lg-4 col-md-4 col-sm-12 col-12 noticias-ultima-hora">
				...
				<?php echo do_shortcode('[recent_post_carousel category="6" show_author="false" limit="8" show_read_more="false" show_category_name="false" slides_to_show="1" content_words_limit="18"]') ?>
